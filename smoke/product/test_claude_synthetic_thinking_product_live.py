...
def test_installed_claude_round_trips_local_thinking_fixture(
    ...
    if fixture is SyntheticThinkingFixture.TOOL_ROUNDTRIP:
        ...
        with start_server(
            ...
            run = run_claude_cli(
                ...
                prompt=(
                    ...
                    if fixture is SyntheticThinkingFixture.TOOL_ROUNDTRIP
                    else "Reply with exactly SYNTHETIC_THINKING_OK."
                ),
                tools="Read"
                if fixture is SyntheticThinkingFixture.TOOL_ROUNDTRIP
                else "",
    ...
    if fixture is SyntheticThinkingFixture.TOOL_ROUNDTRIP:
        ...
        assert "SYNTHETIC_THINKING_OK" in run.combined_output or run.returncode == 0
