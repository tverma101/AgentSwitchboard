...
| [CCR #1693](https://github.com/musistudio/claude-code-router/issues/1693) | Session affinity is missing from a body-only Responses hop | `test_responses_prompt_cache_key_*` plus session-header extraction tests | Current-source verified; live cache benefit still unverified |
