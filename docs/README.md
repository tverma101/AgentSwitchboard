...
| `docs/TERMINAL_CODE_TRANSPLANT.md` | Maintainers and contributors | Record verified terminal-code prior art, the transplanted interaction scope, and the rejected pixel/SSH/extension verbs | Research / decision record | A source pin, transplanted verb, or rejection rationale changes |
