...
The managed Claude environment should therefore disable Claude Code's stream-to-nonstream fallback and let a streaming failure surface to FCC instead of causing an independent client replay.
